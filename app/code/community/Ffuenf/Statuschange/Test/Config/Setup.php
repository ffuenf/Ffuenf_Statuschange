...
class Ffuenf_Statuschange_Test_Config_Setup extends EcomDev_PHPUnit_Test_Case_Config
{
    /**
    ...
    public function testSetupExists() {
        $this->assertSchemeSetupScriptVersions(
            '1.0.0', $this->expected('module')->getVersion(), null, 'ffuenf_statuschange_setup'
        );
    }
}